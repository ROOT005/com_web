...
{{template "product_model" .}}
    <div class="container choice">
      <ul>
          <li class="rangecount" >融资金额:<a class="btn btn-info" href="/products?rangec=0" title="" role="button">全部</a>
          {{range .rangecount}}
            <a class="btn btn-info rangecount" href="/products?rangec={{.ID}}" role="button" id="{{.ID}}">{{.Name}}</a>
          {{end}}
          </li>
